/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3dd5beccfed2b74182807dde72094e36)
// Runtime types generated with workerd@1.20250604.0 2025-06-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NOTIFY_TOKENS: KVNamespace;
		BOT_TOKEN: string;
		HETZNER_IPV6_ID: string;
		HCLOUD_TOKEN: string;
		SELECTEL_ORG_ID: string;
		SELECTEL_PASS: string;
		WG_PRIVATE: string;
		WG_PSK: string;
		AFRAID_V4: string;
		AFRAID_V6: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_TOKEN" | "HETZNER_IPV6_ID" | "HCLOUD_TOKEN" | "SELECTEL_ORG_ID" | "SELECTEL_PASS" | "WG_PRIVATE" | "WG_PSK" | "AFRAID_V4" | "AFRAID_V6">> {}
}
declare module "*.yaml" {
	const value: string;
