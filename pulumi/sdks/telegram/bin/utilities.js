    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (_packageRef === undefined) {
            ...
            if (_packageRef === undefined) {
                ...
                params.setName("telegram");
                params.setVersion("0.3.1");
                params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3lpLWppYXl1L3RlbGVncmFtIiwidmVyc2lvbiI6IjAuMy4xIn19"), c => c.charCodeAt(0)));
