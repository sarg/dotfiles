...
(define-public emacs-ewm
  (package
    (name "emacs-ewm")
    (properties '((commit . "370b698320cdee06dbdeb243db6036d1a144a59e")))
    (version (git-version "0.1.0" "18" (assoc-ref properties 'commit)))
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "183rr5plfhi83nahj0pxp0lh03jysh8k2nri30p98cpmrarw1slq"))))
