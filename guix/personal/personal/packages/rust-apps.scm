...
(define-public emacs-ewm
  (package
    (name "emacs-ewm")
    (properties '((commit . "8524705fdcd863d3272c0a89ab91f2664e452b0f")))
    (version (git-version "0.1.0" "10" (assoc-ref properties 'commit)))
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "14qyxibbxqxg0qal394q1as06aagmmvmm10fsyq009079bjj49hi"))))
