...
(define-public emacs-ewm
  (package
    (name "emacs-ewm")
    (properties '((commit . "5564f93578a830ba9316fdfc3ed1d288d41775d3")))
    (version (git-version "0.1.0" "8" (assoc-ref properties 'commit)))
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "0k7f0xdxf0a5n470n9q1mw9xmliq4d3aacnbrxnq3wp277zl5d6x"))))
