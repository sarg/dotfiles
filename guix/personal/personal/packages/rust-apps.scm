...
(define-public emacs-ewm
  (package
    (name "emacs-ewm")
    (properties '((commit . "4956e7631fa40cd71ec1cf00a6473056c9588fca")))
    (version (git-version "0.1.0" "12" (assoc-ref properties 'commit)))
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "0avvfpxf7g2ps18q1v11lq7qb4xfp219q9fp0nhpr6ss14ijcd50"))))
