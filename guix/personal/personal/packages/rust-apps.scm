...
(define-public emacs-ewm
  (package
    (name "emacs-ewm")
    (properties '((commit . "1e6ad0c9c8f592e25bb3976f353cc587a5ad878c")))
    (version (git-version "0.1.0" "17" (assoc-ref properties 'commit)))
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "1n56dmk355igljscb3xgz8bh11nqm81i0vswg95a3rdlf8as44w0"))))
