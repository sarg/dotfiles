...
(define-public doomemacs
  (package
    (name "doomemacs")
    (properties '((commit . "d2d805a42b141a03c17e5e957bb0b236d691b971")))
    (version (git-version "3.0.0" "7" (assoc-ref properties 'commit)))
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
       ...
       (sha256
        (base32 "1ymlixb4qgixcfp3c30wxza4msbrg7gk5cmclzxdzfc8hblwczvr"))))
