...
compile)
    pushd $DIR
    guix shell -D guix -- ./pre-inst-env make scripts/guix make-go
    popd
    ;;

home)
    $DIR/pre-inst-env guix home reconfigure \
        -L ~/.dotfiles/guix/personal/ \
        ~/.dotfiles/guix/home.scm
    ;;

system)
    $DIR/pre-inst-env guix system reconfigure --save-provenance \
        -L ~/.dotfiles/guix/personal/ \
        -L ~/devel/ext/nonguix/ \
...
deploy)
    $DIR/pre-inst-env sudo -E guix system reconfigure --save-provenance \
        -L ~/.dotfiles/guix/personal/ \
        -L ~/devel/ext/nonguix/ \
        ~/.dotfiles/guix/system.scm
    ;;
...
gc)
    $DIR/pre-inst-env guix gc -d
    ;;

,*)
  if [ "$1" == "" ]; then
      echo "compile|home|system|deploy|gc"
  else
      $DIR/pre-inst-env guix "$@"
  fi
  ;;
esac
#+end_src
...
"emacs-debbugs" "gnu-standards" "mumi"
#+end_src
#+begin_src elisp
(after! debbugs
...
#+end_src
** workspaces
#+begin_src elisp :tangle exwm.el
...
*** global
#+begin_src elisp :tangle exwm.el
(defun exwm/switch-to-next-window (class &optional reverse?)
  (cl-loop
 ...
 "<f13> E"    `(lambda () (interactive)
                 ...
                 (cond
                  ((string= "qutebrowser" exwm-class-name)
                   (exwm/switch-to-next-window "qutebrowser" 'reverse))
...
(package! doom-themes :built-in t)
#+end_src

#+begin_src elisp
(use-package! white-sand-theme)
(use-package! dracula-theme)
(defvar doom-theme-dark 'doom-ayu-mirage)
...
(package! bufler :pin "d686f6a303ed250da2ee01d82afea26058a0a533")
#+end_src
...
(package! org-modern-indent
    ...
    :pin "400e1d0fcec9044203189923ee385736a257b186")
...
*** player
#+begin_src elisp :tangle packages.el
(package! emms-player-spotify :pin "6cf2848da30ddec38d7931124e2a62448cde17c4")
#+end_src
#+begin_src elisp
...
(package! multitran :pin "680f31d15b78876daf484bd926e5c172ab061595")
...
(package! dired-collapse :pin "874449d6fc98aee565e1715ec18acec3c1c2cafb")
...
** TODO periodical jobs
*** TODO fstrim service
*** TODO run them just before hibernating, if the battery is full
*** TODO mcron for updatedb
*** TODO mcron for backup
** TODO guix gc, but not that aggressive
** TODO Fix hardcoded =Guix_image= root partition name
