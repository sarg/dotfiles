...
#+RESULTS[2a46d730d9796a8ad98da26c7aaa74d1c3149124]: cfg-nonguix-pub
#+begin_src text
(mixed-text-file
  "cfg-file"
"(public-key (ecc (curve Ed25519) (q #C1FD53E5D4CE971933EC50C9F307AE2171A2D3B52C804642A7A35F84F3A4EA98#)))")
...
#+RESULTS[5a0b9ff25f6a9de0ab6a6c76762aa00535fd8762]: cfg-resolv-conf
#+begin_src text
(mixed-text-file
  "cfg-file"
"name_servers=127.0.1.1\n"
...
#+RESULTS[9a00997d56353bded0048b673b71540d4b9e1da0]: cfg-udisks-wheel
#+begin_src text
(mixed-text-file
  "cfg-file"
"// Allow udisks2 to mount devices without authentication\n"
...
#+RESULTS[19059da8940d8759d91a7517acece1950cd04287]:
...
#+RESULTS[382344164ebc03915a71b5a5e0df2a5be18980fb]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[a6f87db96c3d9885d2f40c2415614d476f6281db]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[174af137c244dbfff41cf27befd51f237f72dbc5]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[ac210d2af2a8c8fda70d375be750483e48a8e8db]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[c0afcd6a7a2ecf207687227e6e0faef058a2692f]:
#+begin_src text :noweb-ref guix-file
(".xinitrc"
,(mixed-text-file
  "cfg-file"
...
#+RESULTS[efaf751ac43bdfa291730641ebb057f6944f1411]: cfg-mosquitto
#+begin_src text
(mixed-text-file
  "cfg-file"
"listener 1883\n"
...
#+end_src
#+begin_src scheme :tangle ../../guix/doomcfg.scm
(use-modules
 (gnu)
 (gnu artwork)
 (guix)
...
(define pkg specification->package+output)
#+end_src
#+begin_src scheme :noweb-ref doom-config :tangle ../../guix/doomcfg.scm
(package
  (name "doomemacs-config")
  (version "0")
  (source (local-file "../emacs/.doom.d" "src"
                      #:recursive? #t
...
(doom!
 ...
 :checkers    syntax
 :lang        (clojure +tree-sitter) data emacs-lisp (javascript +tree-sitter +lsp)
...
#+RESULTS[9ad9b363b99d582c2020504c019088f2541494f2]:
#+begin_src text :noweb-ref guix-file
(".config/associations"
,(mixed-text-file
  "cfg-file"
...
(exwm/bind-command
   ...
   "<XF86MonBrightnessUp>" (guix/pkg 'brightnessctl "/bin/brightnessctl -e set 10%+")
   "<XF86MonBrightnessDown>" (guix/pkg 'brightnessctl "/bin/brightnessctl -e set 10%-")
   "<XF86ScreenSaver>" "xset s activate"
   "<f13> <f12>" (guix/pkg 'flameshot "/bin/flameshot gui"))
#+end_src
** dark mode
#+begin_src scheme :noweb-ref guix-pkg
"darkman"
...
#+RESULTS[a1027b9cfb5d62886b1faad9cd5536746e5d3ee7]:
#+begin_src text :noweb-ref guix-file
...
#+end_src
#+begin_src elisp
(load! "ob-cfg.el") ; to tangle config.org
...
(after! org-download
  (setq org-download-screenshot-method
        (guix/pkg 'flameshot "/bin/flameshot gui --raw > %s")))
...
#+RESULTS[e733d18b143dded885690bba82074360f571bfb1]:
#+begin_src text :noweb-ref guix-file
(".justfile"
,(mixed-text-file
  "cfg-file"
...
#+RESULTS[95c2afbbb3a42d141846d8c6a9482785cdf3a86c]:
#+begin_src text :noweb-ref guix-file
(".gitconfig"
,(mixed-text-file
  "cfg-file"
...
#+RESULTS[352b7d804af84b495386e051d9df660975edb8d3]:
#+begin_src text :noweb-ref guix-file
...
("BROWSER" . "qutebrowser")
#+end_src
#+begin_src cfg :tangle-mode "u+x" :dest ".local/share/dark-mode.d/qutebrowser"
...
#+RESULTS[fbdbd7d5cfcbf1ff96b52e07ded04403341f8621]:
#+begin_src text :noweb-ref guix-file
...
#+begin_src cfg :tangle-mode "u+x" :dest ".local/share/light-mode.d/qutebrowser"
#!🐜(pkg "bash-minimal")🐜/bin/sh
cat <<EOF > ~/.config/qutebrowser/darkmode.py
...
#+RESULTS[40d25edf97d0468c05dbafe4d9b5d60d9c9d5220]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[40dafbbdadea909f99c99c0671bb9de1f6925309]: cfg-bash
#+begin_src text
(mixed-text-file
  "cfg-file"
"[ -n \"$EAT_SHELL_INTEGRATION_DIR\" ] && source \"$EAT_SHELL_INTEGRATION_DIR/bash\"\n"
