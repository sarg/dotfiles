...
(add-hook 'doom-init-ui-hook
          (defun sarg/noctalia ()
            ...
            ; force noctalia to use labwc workspace service
...
(let ((base (pkg "emacs-doom-themes")))
  (package
   (inherit base)
   (source
    (origin
     ...
     (snippet #~(substitute* "doom-themes-base.el"
                  (("(tab-line.+)bg-alt\\)" _ prefix)
                   (string-append prefix "fg-alt)"))))))))
#+end_src
#+begin_src elisp
...
(pin "emacs-calibredb"
     ...
     #:hash "0jkhaf5h2qcqz8nvw80wj0xjazdpm2l9n0d5a41p20gnz54rhkbd")
#+end_src
#+begin_src scheme :noweb-ref guix-pkg
