...
(package! iwd-manager
  :recipe (:host github :repo "sarg/wifi-manager" :files ("iwd-manager.el"))
  :pin "ec2b209e408eef08d19fa135253aa22a0317815a")
#+end_src
#+begin_src elisp
...
(use-package! yeetube
  ...
  (map! :map yeetube-mode-map
        :n "RET" #'yeetube-play
        :n "go" (lambda () (interactive)
                  (browse-url-generic (yeetube-get-url)))))
#+end_src
* shell
#+begin_src elisp :tangle packages.el
