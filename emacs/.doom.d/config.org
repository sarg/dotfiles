...
#+end_src
* home.scm template
#+begin_src scheme :noweb-ref nil :tangle ~/devel/dotfiles/guix/home.scm :exports none
;; generated from config.org
(use-modules
 (gnu)
 (gnu artwork)
...
(define (pkg x)
  (if (string? x) (specification->package+output x) x))
...
#+RESULTS[cb2175e995d635acf1d08c01366829afac80ffe8]:
...
#+RESULTS[1d110c70333f0662f3ef657c241a1254076d8da3]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[41a4761751301563b5829ddcdb739da575c84771]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[c0f957fd6ec042c723a189a752494909afc53e2e]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[52ea22c206099d9f59631a452159fdcac1d4e0a6]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[16d4a68d39d7eca6c13ec8546dd98e14ba708453]:
#+begin_src text :noweb-ref guix-file
(".xinitrc"
,(mixed-text-file
  "cfg-file"
...
(service
 ...
 (let ((pixel (syncthing-device (id "Q4ZQAU5-ZBFVS3E-OULHHHM-3HOCUXT-TVV5UYL-XPZRRWH-EXYYJWG-WVAUAAS")))
   ...
   (for-home (syncthing-configuration
              (arguments '("--data=/storage/data/syncthing"
                           "--config=.local/state/syncthing"))
              (config-file
...
#+RESULTS[6c69b22e57a6a059f2edeee700647503864f3a90]: cfg-mosquitto
#+begin_src text
(mixed-text-file
  "cfg-file"
"listener 1883\n"
...
#+RESULTS[473a0e9deb4afda552ae48522c3ed1ad2a4a78cf]:
#+begin_src text :noweb-ref guix-file
(".config/associations"
,(mixed-text-file
  "cfg-file"
...
#+RESULTS[3b0d89f7cd9a2190e0b8f0c97833c9c47b81bf01]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[9e0b8f4bbfa4334959fcac62cedd3fc6f0115b4f]:
#+begin_src text :noweb-ref guix-file
(".justfile"
,(mixed-text-file
  "cfg-file"
...
#+RESULTS[3c508390d04187cb80d16b03321c315e19755151]:
#+begin_src text :noweb-ref guix-file
(".gitconfig"
,(mixed-text-file
  "cfg-file"
...
#+RESULTS[8de98bd4192bf531aa3c0458ec57e9742aca84c6]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[e9ab3a9a5ffa2cecd3591cd96d0acac6ab58d6f4]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[38ffc05e4c296df8734f5dd37967bd6882f45a8e]:
#+begin_src text :noweb-ref guix-file
...
#+RESULTS[3bc21a5abbd58df0dc09573a45968149bab50439]: cfg-bash
#+begin_src text
(mixed-text-file
  "cfg-file"
"[ -n \"$EAT_SHELL_INTEGRATION_DIR\" ] && source \"$EAT_SHELL_INTEGRATION_DIR/bash\"\n"
