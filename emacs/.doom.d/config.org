...
(doom!
 ...
 :lang        (clojure +tree-sitter) data emacs-lisp (javascript +tree-sitter +lsp) markdown
              (org +dragndrop +pandoc +hugo +roam2 +pretty) beancount (go +lsp +tree-sitter) (rust +lsp +tree-sitter)
...
(use-package darkman
  ...
  (add-hook! 'doom-init-ui-hook #'darkman-mode))
#+end_src
** COMMENT redshift
#+begin_src scheme :noweb-ref guix-srv
(service
...
(use-package qutebrowser
  ...
  :hook ((exwm-init . global-qutebrowser-exwm-mode)
         ...
         (exwm-init . qutebrowser-fileselect-mode))
  :custom
