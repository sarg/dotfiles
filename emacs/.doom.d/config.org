...
(define all-packages (map pkg (flatten (list <<guix-pkg>>))))
(home-environment
  (services
   (cons*
    (simple-service
...
#+RESULTS[a154ad1497589cba40398eedc880491005bd04e6]:
#+begin_src text :noweb-ref guix-file
(".xinitrc"
,(mixed-text-file
  "cfg-file"
...
* doom
** base packages
#+begin_src scheme :noweb-ref doom-pins
...
;; https://codeberg.org/guix/guix/pulls/5419
(pin "emacs-general"
     #:commit "a48768f85a655fe77b5f45c2880b420da1b1b9c3"
     #:hash "19k82p8pwyh3krq8i6l6calwy9wddqklj1klkdyawgh5ar230vb2")
(pin "emacs-evil-mc"
     #:commit "7e363dd6b0a39751e13eb76f2e9b7b13c7054a43"
     #:hash "0gzy2mqcdxhkg0hmxqzbjy5ihfal1s21wxd04mrikqri54sck4z5")
(pin "emacs-nerd-icons"
     #:commit "772987a28d6408f840331c52c91d04b623a87048"
     #:hash "0n3kjz3ir43ghs0pq86plcz5mpf3m0qn19ahi0705pv56hgvr0h8")
...
#+begin_src scheme :noweb-ref guix-pkg
home-emacs
(let ((pins (list <<doom-pins>>)))
  (append
   (map cdr pins)
   (map (compose (package-input-rewriting pins) pkg)
...
(service
 ...
 (let ((pins (list <<doom-pins>>)))
   (doomemacs-configuration
    (emacs home-emacs)
    (doomemacs ((package-input-rewriting pins) (pkg "doomemacs")))
...
((package-input-rewriting
  (list (pin "emacs-shell-maker"
             #:commit "v0.84.7"
             #:hash "0x10qjhcym4nnv5zh4nwy7d46lp158q06w2iwgi265nl1bz9s7yq")))
  (pkg "emacs-agent-shell"))
#+end_src
** gemini
#+begin_src scheme :noweb-ref guix-pkg
"google-gemini-cli"
