...
(define* (pin p #:key commit hash uri)
  (let ((base (pkg p)))
    (cons base
          (package
            (inherit base)
            (version (string-append "pin." (string-take commit 7)))
            (source
             (origin
...
* ewm
#+begin_src scheme :noweb-ref guix-pkg
"emacs-ewm" "noctalia-git" "xwayland-satellite"
#+end_src
#+begin_src scheme :noweb-ref guix-srv
(simple-service
 'emacs
...
(pin "emacs-evil-collection"
     ...
     #:hash "00jjs2py2836z3450nq1v2p6fv1i1dhalkd9yy2qg366jddc074r")
(pin "emacs-evil-org"
...
(cdr (pin "doomemacs-modules"
          #:commit "28f09d8afe81fa47ab83020b072f0dfa2f79dbdb"
          #:hash "1904hwpa7i8qp799csgs2a5awm7i4d8h1rvkqw6r35ys2lsf1sb7"))
#+end_src
