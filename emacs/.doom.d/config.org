...
(home-environment
  ...
  (packages (map pkg (flatten (list <<guix-pkg>>)))))
#+end_src
* apps
** android
#+begin_src scheme :noweb-ref guix-pkg
...
(transient-define-prefix dash-menu/audio ()
  ...
  [["Playlist"
   ...
   ["EMMS"
    ...
    ("<right>" "next" (lambda () (interactive) (funcall emms-player-next-function)) :transient t)
...
(let* ((emacs-nerd-icons (pkg "emacs-nerd-icons"))
       (emacs-nerd-icons-next
       ...
       (r (package-input-rewriting `((,emacs-nerd-icons . ,emacs-nerd-icons-next)))))

  (list emacs-nerd-icons-next
        (map (compose r pkg)
...
; don't use and don't want to package these
 ...
 (doomemacs-configuration
  ...
  (doomemacs
   (let* ((straight (pkg "emacs-straight"))
          (straight-next (build-with-home-emacs straight))
          (r (package-input-rewriting `((,straight . ,straight-next)))))
     (r (pkg "doomemacs"))))
...
(use-package! openwith
  ...
  (openwith-associations
   '(("\\.\\(?:djvu\\|mkv\\|webm\\|avi\\|mp4\\)\\'" "jaro" (file))))
