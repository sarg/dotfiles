...
(let ((straight (pkg "emacs-straight")))
  (cons straight (build-with-home-emacs straight)))
#+end_src
#+begin_src scheme :noweb-ref guix-pkg
home-emacs
...
(doom!
 :completion  (corfu +icons +orderless) (vertico +icons) ;(ivy +fuzzy +prescient +childframe)
...
** agent-shell
#+begin_src scheme :noweb-ref guix-pkg
"emacs-shell-maker" "emacs-acp" "emacs-agent-shell"
#+end_src
