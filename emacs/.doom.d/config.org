...
(defun sarg/vpn-stop ()
  ...
  (let ((bot (telega-user--by-username "DiogenisBot")))
    ...
    (promise-chain
        (sarg/telega-msg-expect bot (lambda (txt) (s-matches? "Stopped.+VPN" txt)))
      (then (lambda (msg)
              (notifications-notify :title "Hey" :body msg))))))
#+end_src
** hardware
...
(transient-define-prefix dash-menu/spotify ()
  "Spotify search"
  [("a" "album" counsel-spotify-search-album)
   ("p" "playlist" counsel-spotify-search-playlist)
   ("A" "artist" counsel-spotify-search-artist)])

(transient-define-prefix dash-menu/audio ()
  "Audio menu"
  [["Playlist"
    ("a" "Spotify" dash-menu/spotify)
