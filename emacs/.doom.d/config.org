...
#+end_src
** workspaces
#+begin_src elisp :noweb-ref exwm
...
* desktop
** desktop entries
Put [[https://github.com/isamert/jaro][jaro]] to =~/.local/bin/xdg-open=
#+begin_src scheme
...
(package! zathura-sync-theme
  ...
  :pin "727fd14fd755a4468ee07789f4b6d41fc6f8d93b")
#+end_src
...
(use-package! openwith
  ...
  (openwith-associations
   '(("\\.\\(?:pdf\\|epub\\|mkv\\|webm\\|avi\\|mp4\\)\\'" "xdg-open" (file))))
