...
(defun sarg/vpn-start (country)
  ...
  (let ((bot (telega-user--by-username "DiogenisBot")))
    ...
    (sarg/telega-msg-send bot (concat "/vpn " country))
    (promise-chain
        (sarg/telega-msg-expect bot (lambda (txt) (s-starts-with? "VPN started" txt)))
      (then (lambda (msg)
              ...
              (notifications-notify :title "Hey" :body msg))))))
...
(defun sarg/vpn-stop ()
  ...
  (let ((bot (telega-user--by-username "DiogenisBot")))
    ...
    (promise-chain
        (sarg/telega-msg-expect bot (lambda (txt)
                                      (or
                                       (s-matches? "Stopped.+VPN" txt)
                                       (string= "Nothing to stop" txt))))
      (then (lambda (msg)
              (notifications-notify :title "Hey" :body msg))))))
#+end_src
** hardware
