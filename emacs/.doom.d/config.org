...
(define home-emacs (pkg "emacs-next"))
...
(pin "emacs-telega"
     ...
     #:hash "0kmvvksff1b7ymc02p3i1224lcsghwjgrvpfv1czs4rfpij7h51m")
#+end_src
#+begin_src scheme :noweb-ref guix-pkg
...
ulimit -n 8192 # potentially prevents "too many open files" errors in emacs
while true; do
...
#+RESULTS[e45ce76c2f65577b674b9f3ef15dc8099e8f2c15]:
#+begin_src text :noweb-ref guix-file
(".xinitrc"
,(mixed-text-file
  "cfg-file"
...
[[https://www.reddit.com/r/linux/comments/1em8biv/psa_pipewire_has_been_halving_your_battery_life/][fix camera draining battery]] https://codeberg.org/guix/guix/pulls/5990
...
(doom!
 ...
 :app         telega (rss +org) torrent irc exwm dash-menu
 ...
 (home-darkman-configuration
  (darkman
   (cdr (pin "darkman"
             ...
             #:hash "1rkwjs3rjrzw6gkcm4q91d0axhdhnrwfp4f503dji2jvs8wqa33m")))
  (latitude 52.52)
  (longitude 13.39)))
#+end_src
...
(pin "emacs-qutebrowser"
     ...
     #:commit "805c1ddc3685dfafec4bef7ada09135620ccd48e"
     #:hash "0yd7p2pjcf7fn1bmp1p0ys0yn8qa6ilba5lqsqkd2ijys8frmwq4")
#+end_src
#+begin_src scheme :noweb-ref guix-pkg
...
(pin "emacs-yeetube"
     ...
     #:hash "0jydjijmmj1nkr4462w5j5b3hhy7ms43zpxs325mjna6f9cmylgd")
     #+end_src
#+begin_src scheme :noweb-ref guix-pkg
"emacs-yeetube"
#+END_src
...
** DONE how to make home services depend on online status?
see [[*online][online]]
