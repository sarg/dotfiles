  ...
  [["Play"
    ...
    ("l" "Likes" (lambda () (interactive)
                   (with-current-emms-playlist
                     ...
                     (emms-random))))]
   ["EMMS"
    ("<delete>" "pause" emms-pause :format "Del %d")
    ("<right>" "next" (lambda () (interactive) (funcall emms-player-next-function)) :transient t :format "  → %d")
    ("<left>" "prev" emms-previous :transient t :format "  ← %d")]

   ["Sound"
    ("<prior>" "volume up" (lambda () (interactive) (my-vol-change 1)) :transient t :format "PgUp %d")
    ("<next>" "volume down" (lambda () (interactive) (my-vol-change -1)) :transient t :format "PgDn %d")]])
