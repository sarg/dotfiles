...
#+PROPERTY: header-args :noweb-prefix no :noweb yes
#+PROPERTY: header-args:elisp :tangle config.el
#+PROPERTY: header-args:scheme :tangle no :exports code
#+PROPERTY: header-args:cfg :tangle no
...
#+end_src
#+begin_src scheme :noweb-ref guix-file
(".config/aria2/aria2.conf" ,<<cfg-aria2()>>)
#+end_src
** mpv
#+begin_src scheme :noweb-ref guix-pkg
...
#+end_src
#+begin_src scheme :noweb-ref guix-file
(".config/oama/config.yaml" ,<<cfg-oama()>>)
#+end_src
*** sending
#+begin_src scheme :noweb-ref guix-pkg
"msmtp"
...
#+end_src
#+begin_src scheme :noweb-ref guix-file
(".config/direnv/lib/sops.sh" ,<<cfg-direnv-sops()>>)
...
#+name: cfg-password-fill
#+begin_src cfg :session '(:name "password_fill_rc")
choose_entry() {
...
#+end_src
#+begin_src scheme :noweb-ref guix-file
(".config/gtk-3.0/settings.ini" ,<<cfg-gtk()>>)
#+end_src
...
#+end_src
#+begin_src scheme :noweb-ref guix-file
(".config/darkman/config.yaml" ,<<cfg-darkman()>>)
#+end_src
#+begin_src elisp
(use-package! darkman
  :custom
...
#+end_src
#+begin_src scheme :noweb-ref guix-file
(".config/zathura/zathurarc" ,<<cfg-zathurarc()>>)
#+end_src
#+begin_src elisp :tangle packages.el
...
("BROWSER" . "qutebrowser")
#+end_src
#+name: cfg-darkman-qutebrowser-dark
#+begin_src cfg :tangle-mode "u+x"
...
#+end_src
#+name: cfg-darkman-qutebrowser-light
#+begin_src cfg :tangle-mode "u+x"
#!🐜(pkg "bash-minimal")🐜/bin/sh
cat <<EOF > ~/.config/qutebrowser/darkmode.py
...
(".local/share/dark-mode.d/qutebrowser" ,<<cfg-darkman-qutebrowser-dark()>>)
(".local/share/light-mode.d/qutebrowser" ,<<cfg-darkman-qutebrowser-light()>>)
#+end_src
#+begin_src elisp
