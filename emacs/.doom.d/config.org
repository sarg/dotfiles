...
(pin "emacs-iwd-manager"
     #:commit "0bca13f9c5baa80f0ecced9ea943ebe99f4e6d17"
     #:hash "17i9yl6h87qvnwgckfqgjdhaq0j4rgk71bkkir3xjn1q98pls5zh")
#+end_src
...
** base packages
#+begin_src scheme :noweb-ref guix-pin
;; https://codeberg.org/guix/guix/pulls/5492
(pin "emacs-elisp-demos"
     #:commit "1a108d1c5011f9ced58be2ca98bea1fbd4130a2f"
     #:hash "1rw7v8xks6rpjk10kw0lkb3f158jsqk6167f3dpmxm3q4000k8nz")
#+end_src
#+begin_src scheme :noweb-ref guix-pin
(pin "emacs-dirvish"
     #:uri "https://github.com/latiagertrutis/dirvish"
     #:commit "300b6b2536006aaf5f803775ca93ca5f6ec35de1"
     #:hash "11849fiaz9vg1dwvvfwz0c5rzh01wx11rqq2r2sg71mj00yfvkb5")
#+end_src
#+begin_src scheme :noweb-ref guix-pkg
home-emacs
...
(defadvice! +set-snippet-dir (fun &rest args)
  ...
  (let ((+snippets-dir (expand-file-name "~/devel/otfiles/emacs/.doom.d/snippets")))
    (apply fun args)))
#+end_src
** my lisp code
#+begin_src scheme :noweb-ref guix-pkg
...
** evil
#+begin_src scheme :noweb-ref guix-pin
(pin "emacs-evil-collection"
     #:commit "3.0.1"
     #:hash "07rqmz87159z0gq75i036v079fdws6x726na6sw37amd4lhqf87p")
(pin "emacs-evil-org"
     #:uri "https://github.com/doomelpa/evil-org-mode"
     #:commit "06518c65ff4f7aea2ea51149d701549dcbccce5d"
     #:hash "11r3aim8qvyddp9d7sphcd0hl3vwxl81z83aifzgx89jb5ivfn6y")
#+end_src
** init.el
#+begin_src scheme :noweb-ref emacs-dep
(cdr (pin "doomemacs-modules"
     #:commit "b9391c34dbb26df79d804444def3371c1ca8c342"
     #:hash "1ia8hs9ma88hkbnrwx1qcynw0bhzqg36mp3c0a29if3rlkrl7vjx"))
#+end_src
#+begin_src elisp :tangle init.el
;; generated from config.org
(add-to-list 'doom-module-load-path (guix/pkg 'doomemacs-modules "/share/doomemacs/modules"))
...
(doom!
 ...
 :checkers    syntax
 :lang        (clojure +tree-sitter) data emacs-lisp (javascript +tree-sitter +lsp) (markdown +grip)
...
** dashboard
#+begin_src scheme :noweb-ref emacs-dep
(list "guix-artwork" (@ (gnu artwork) %artwork-repository))
#+end_src
#+begin_src elisp
...
#+RESULTS[4174896d10de9e6caad4ca208dfe152c38b3e59e]:
#+begin_src text :noweb-ref guix-file
(".config/git/config"
,(mixed-text-file
  "cfg-file"
...
* shell
#+begin_src scheme :noweb-ref guix-pkg
"emacs-eat" "emacs-detached" "direnv" "atuin" "emacs-eshell-atuin"
#+end_src
...
(use-package agent-shell
  ...
  :custom (agent-shell-preferred-agent-config '(preselect . pi)))
#+end_src
** opencode
#+begin_src scheme :noweb-ref guix-pkg
"emacs-opencode"
